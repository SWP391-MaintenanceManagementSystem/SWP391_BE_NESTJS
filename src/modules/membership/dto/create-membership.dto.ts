...
export class CreateMembershipDTO {
    ...
    @ApiProperty({ description: 'The period type of the membership', example: 'DAY', enum: PeriodType })
    ...
    @ApiProperty({ description: 'The description of the membership', example: 'This is a gold membership plan.' })
    description?: string;
}
